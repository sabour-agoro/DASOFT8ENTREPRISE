      ...
      >
        ...
        >
          <div className="h-[60px] flex items-center justify-between px-6 z-20 relative">
            <div
              className="flex flex-col justify-center gap-[6px] w-8"
              style={{ color: menuColor }}
            >
              <div
                className={`h-[2px] bg-current transition-all duration-300 ${isExpanded ? "w-7 translate-y-2 rotate-45" : "w-7"}`}
              />
              <div
                className={`h-[2px] bg-current transition-all duration-300 ${isExpanded ? "w-0 opacity-0" : "w-5"}`}
              />
              <div
                className={`h-[2px] bg-current transition-all duration-300 ${isExpanded ? "w-7 -translate-y-2 -rotate-45" : "w-7"}`}
              />
